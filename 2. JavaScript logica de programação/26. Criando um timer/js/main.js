...
function progressBars(s, m, h) {
    ...
    circleSeconds.style.strokeDashoffset = 430 - (380 * (progressSeconds / 100));
    circleMinutes.style.strokeDashoffset = 430 - (380 * (progressMinutes / 100));
    circleHours.style.strokeDashoffset = 430 - (380 * (progressHours / 100));
}